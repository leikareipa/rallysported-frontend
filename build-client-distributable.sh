...
SOURCE_FILES=("$SRC_DIRECTORY/jszip/jszip.min.js"
              ...
              "$SRC_DIRECTORY/rallysported-js/game-content/game-content.js"
              "$SRC_DIRECTORY/rallysported-js/game-content/varimaa.js"
              "$SRC_DIRECTORY/rallysported-js/game-content/maasto.js"
              "$SRC_DIRECTORY/rallysported-js/game-content/kierros.js"
              "$SRC_DIRECTORY/rallysported-js/game-content/palat.js"
              "$SRC_DIRECTORY/rallysported-js/game-content/props.js"
              ...
              "$SRC_DIRECTORY/rallysported-js/scene/terrain-editor/camera.js"
              "$SRC_DIRECTORY/rallysported-js/scene/terrain-editor/mesh-builder.js"
              "$SRC_DIRECTORY/rallysported-js/scene/terrain-editor/rngon-minimal-fill.js"
              "$SRC_DIRECTORY/rallysported-js/scene/terrain-editor/rngon-minimal-tcl.js"
              ...
              "$SRC_DIRECTORY/rallysported-js/scene/loading-spinner/loading-spinner.js"
